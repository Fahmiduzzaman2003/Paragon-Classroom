...
export function CourseOverview() {
  ...
  const isOwner = !!user && (user.id === course.teacherId || user.role === 'admin')
  ...
  return (
    <div className="grid lg:grid-cols-[1fr_320px] gap-5">
      <div className="space-y-5">
        ...
        {isOwner && <DangerZone course={course} />}
      </div>
...
function DangerZone({ course }: { course: Course }) {
  ...
  return (
    <>
      <GlassCard padding="md" className="border-destructive/30">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 justify-between">
          <div className="min-w-0">
            <h3 className="font-display text-sm font-semibold text-destructive">Danger zone</h3>
            <p className="text-[11px] text-muted-foreground mt-1 leading-relaxed">
              Deleting this course removes its materials, quizzes, assignments, forum threads
              and every student's work in it. This cannot be undone.
            </p>
          </div>
          <GlassButton
            variant="destructive"
        ...
        <GlassModalContent size="sm">
          ...
          <form onSubmit={submit} className="space-y-3">
            ...
            <GlassModalFooter>
              ...
              <GlassButton type="submit" variant="destructive" disabled={!canDelete || del.isPending}>
